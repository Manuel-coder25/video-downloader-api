...
const CONFIG = {
  ...
  ALLOWED_PLATFORMS: [
    ...
    { name: "twitter", domains: ["twitter.com", "x.com"] } // ✅ ADDED
  ],
...
app.post("/download", downloadLimiter, async (req, res) => {
  ...
  try {
    ...
    // ✅ COOKIES SUPPORT (UPDATED FOR TWITTER)
    if (
    ...
    if (platform === "twitter" && !hasCookies()) {
      console.log("⚠️ No cookies - some Twitter videos may fail");
    }
